        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col space-y-2">
              ...
              <li>
                <a href="/works" className="hover:text-gray-400 transition duration-300">Our Works</a>
              </li>
              <li>
          ...
          <div className="flex flex-col md:ml-[-60%]">
            ...
            <p className="text-gray-400">
              ...
              Our commitment to excellence drives us to continually push boundaries and innovate.
            </p>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <p>
              Email: <a href="mailto:info@yourcompany.com" className="text-blue-400 hover:underline">info@yourcompany.com</a>
            </p>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 0H2C0.895 0 0 0.895 0 2v20c0 1.105 0.895 2 2 2h11v-9H9v-3h4V7c0-4.418 3.582-8 8-8h3v3h-3c-2.207 0-4 1.793-4 4v4h6l-1 3h-5v9h11c1.105 0 2-0.895 2-2V2c0-1.105-0.895-2-2-2z"/>
                </svg>
              </a>
              <a
