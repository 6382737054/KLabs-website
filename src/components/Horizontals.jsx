...
const Horizontals = () => {
  const numItems = 8; // Number of items you want to render

  // Create an array of refs and visibility state
  ...
  // List of content with images and text
  const content = [
  ...
  return (
    <div className="p-8 mt-20 space-y-16">
      {/* Heading */}
      <h1 className="text-3xl font-bold text-gray-800 mb-12 text-center">Our Horizontals</h1>
