...
const HeroSection = () => {
  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-between min-h-screen bg-white overflow-hidden" id="home">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-white via-gray-100 to-white opacity-80"></div>
      ...
      <div className="relative w-full md:w-2/3 flex flex-col md:flex-row items-center md:items-start justify-start px-4 md:px-16 lg:px-32 py-10 md:py-16 mt-16 md:mt-0">
        <div className="relative text-left w-full">
          <div className="space-y-4 md:space-y-6">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-1 leading-tight text-orange-600">
              Transform Your Business <br className="hidden md:block" /> with Cutting-Edge Technology
            </h2>
            <div className="w-24 h-1 bg-orange-600 mb-3"></div>
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
              <button
                ...
                className="px-6 py-3 bg-orange-600 text-white font-semibold rounded-lg shadow-lg hover:bg-orange-700 hover:scale-105 transition-transform duration-300"
              >
                Our Clients
              </button>
              <button
                onClick={scrollToAboutUs}
                className="px-6 py-3 bg-transparent border-2 border-gray-800 text-gray-800 font-semibold rounded-lg shadow-lg hover:bg-gray-800 hover:text-white hover:scale-105 transition-transform duration-300"
              >
                About Us
              </button>
            </div>
      ...
      <div className="relative w-full md:w-1/3 flex items-center justify-center px-4 md:px-8 py-10 md:py-16 mt-6 md:mt-12">
        <div className="bg-gradient-to-br from-[#f5deb3] via-[#f3e5ab] to-[#fdf5e6] p-6 md:p-8 shadow-xl border border-white-300 w-full max-w-sm min-h-[500px] flex flex-col items-center justify-center space-y-8 hover:scale-105 transition-transform duration-300">
